...
namespace Slim.Core
{
  ...
  internal class ISerializableFixup
    {
    ...
    internal class RefPool
    {
       ...
       private Dictionary<object, int> m_Dict = new Dictionary<object,int>(PoolCapacity, ReferenceEqualityComparer<object>.Instance);
       private List<ISerializableFixup> m_Fixups = new List<ISerializableFixup>();
       private List<OnDeserializedCallback> m_OnDeserializedCallbacks = new List<OnDeserializedCallback>();

       public int Count => m_List.Count;

       public List<ISerializableFixup> Fixups => m_Fixups;
       ...
       public void AddISerializableFixup(object instance, SerializationInfo info)
       {
         ...
         m_Fixups.Add( new ISerializableFixup{ Instance = instance, Info = info } );
       }
